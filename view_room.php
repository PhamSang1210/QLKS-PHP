...
<div class="card card-outline card-primary rounded-0 shadow mb-5">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button class="btn btn-primary btn-sm btn-flat" type="button" id="reserve_room"><i class="fa fa-edit"></i>
                Đăng Ký Phòng</button>
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl>
                        ...
                        <dt class="text-muted">Kiểu Phòng</dt>
                        <dd class='pl-4 fs-4 fw-bold'>
                            <?= isset($type) ? $type : 'N/A' ?>
                        </dd>
                    </dl>
                ...
                <div class="col-md-6">
                    <dl>
                        ...
                        <dd class='pl-4 fs-4 fw-bold'>
                            <?= isset($price) ? number_format($price, 0, '.', '.') . "đ" : '0.00' ?>
                        </dd>
                        ...
                        <dd class='pl-4 fs-4 fw-bold'>
                            ...
                            if (isset($status)) {
                                switch ($status) {
                                    case '1':
                                        echo '<span class="px-4 badge badge-success rounded-pill">Hoạt Động</span>';
                                        break;
                                    case '0':
                                        echo '<span class="px-4 badge badge-danger rounded-pill">Không hoạt động</span>';
                                        break;
                                }
                            }
...
<script>
    $(function () {
        $('#reserve_room').click(function () {
            uni_modal("Đặt phòng cho <?= $name ?>", "reserve.php?rid=<?= isset($id) ? $id : '' ?>", 'mid-large')
        })
