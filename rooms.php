                ...
                <div class="card-body">
                    <div class="list-group" id="room-list">
                        ...
                        while ($row = $rooms->fetch_assoc()):
                            ...
                            ?>
                            <a href="./?page=view_room&id=<?= $row['id'] ?>"
                                class="text-decoration-none text-dark room-item list-group-item list-group-item-action">
                                <div class="d-flex align-items-top">
                                    <div class="col-auto">
                                        <div class="room-holder overflow-hidden">
                                            <img src="<?= validate_image($row['image_path']) ?>"
                                                class="img-thumbnail rounded-0 room-img" alt="<?= $row['name'] ?> Image">
                                        </div>
                                    </div>
                                    <div class="col-auto flex-grow-1 flex-shrink-1">
                                        <h3 class="text-navy mb-0"><b>
                                                <?= $row['name'] ?>
                                            </b></h3>
                                        ...
                                        <h4 class='text-success'><small><span class="tex-muted mr-3"><i
                                                        class="fa fa-tag"></i></span></small>
                                            <?= number_format($row['price'], 0, '.', '.') ?>đ<small><span>/</span>
                                                ngày</small>
                                        </h4>
                                    </div>
                                </div>
