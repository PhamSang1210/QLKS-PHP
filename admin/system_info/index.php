	...
	<div class="card card-outline card-dark rounded-0 shadow">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="" class="control-label">Biểu tượng hệ thống</label>
				...
				<div class="form-group">
					<label for="" class="control-label">Che phủ</label>
					<div class="custom-file">
				...
				<fieldset>
					...
					<div class="form-group">
						<label for="address" class="control-label">Địa chỉ văn phòng</label>
