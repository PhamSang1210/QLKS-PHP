	...
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span
					class="fas fa-plus"></span> Thêm hoạt động mới</a>
		</div>
	</div>
	<div class="card-body">
						...
						while ($row = $qry->fetch_assoc()):
							...
							<tr>
								...
								<td class="text-center">
									...
									switch ($row['status']) {
										case 0:
											echo '<span class="rounded-pill badge badge-danger col-6">Chưa Kích Hoạt</span>';
											break;
										case 1:
											echo '<span class="rounded-pill badge badge-success col-6">Kích Hoạt</span>';
											break;
									}
									?>
								</td>
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item"
											href="./?page=activities/view_activity&id=<?= $row['id'] ?>"
...
<script>
	$(document).ready(function () {
		$('#create_new').click(function () {
			uni_modal("Thêm hoạt động mới", "activities/manage_activity.php", 'mid-large')
		})
		$('.edit_data').click(function () {
			uni_modal("Cập nhật chi tiết hoạt động", "activities/manage_activity.php?id=" + $(this).attr('data-id'), 'mid-large')
		})
		$('.delete_data').click(function () {
			_conf("Bạn có chắc chắn xóa hoạt động này vĩnh viễn?", "delete_activity", [$(this).attr('data-id')])
		})
		$('.view_data').click(function () {
			uni_modal("chi tiết hoạt động", "activities/view_activity.php?id=" + $(this).attr('data-id'))
		})
