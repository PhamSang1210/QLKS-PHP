					...
					<tbody>
						...
						while ($row = $qry->fetch_assoc()):
							...
							<tr>
								...
								<td class="text-center">
									<?php if ($row['status'] == 1): ?>
										<span class="badge badge-pill badge-success">Đọc</span>
									<?php else: ?>
										<span class="badge badge-pill badge-primary">Chưa đọc</span>
									<?php endif; ?>
								</td>
								<td align="center">
									<button type="button"
...
<script>
	$(document).ready(function () {
		$('.delete_data').click(function () {
			_conf("Bạn có chắc chắn xóa Yêu cầu này vĩnh viễn?", "delete_message", [$(this).attr('data-id')])
		})
		$('.table td,.table th').addClass('py-1 px-2 align-middle')
		$('.view_details').click(function () {
			uni_modal('Chi tiết yêu cầu', "inquiries/view_details.php?id=" + $(this).attr('data-id'), 'mid-large')
		})
		$('.table').dataTable();
