  ...
  <div class="d-flex justify-content-between w-100">
    ...
    <div>
      <?php if ($_settings->userdata('id') > 0): ?>
        ...
        <span class="mx-2">Xin Chào,
          <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?>
        </span>
      ...
      <?php else: ?>
        <a href="./admin" class="mx-2 text-light">
          <img style="width:22px;height: 22px;" src="uploads/icon/login.png" alt="login">
          Đăng Nhập
        </a>
      <?php endif; ?>
    </div>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="./?page=rooms" class="nav-link <?= isset($page) && $page == 'rooms' ? "active" : "" ?>">Phòng</a>
        </li>
        <li class="nav-item">
          <a href="./?page=activities" class="nav-link <?= isset($page) && $page == 'activities' ? "active" : "" ?>">Các
            hoạt động</a>
        </li>
        <li class="nav-item">
          <a href="./?page=about" class="nav-link <?= isset($page) && $page == 'about' ? "active" : "" ?>">Về chúng
            tôi</a>
        </li>
        <li class="nav-item">
          <a href="./?page=contact_us"
            class="nav-link <?= isset($page) && $page == 'contact_us' ? "active" : "" ?>">Liên hệ chúng tôi</a>
        </li>
        <?php if ($_settings->userdata('id') > 0 && $_settings->userdata('login_type' != 1)): ?>
          <li class="nav-item">
            <a href="./?page=profile" class="nav-link <?= isset($page) && $page == 'profile' ? "active" : "" ?>">Hồ sơ</a>
          </li>
        <?php endif; ?>
        <!-- <li class="nav-item">
